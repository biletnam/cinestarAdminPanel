...
angular
    ...
    .config(['$stateProvider', '$urlRouterProvider', '$ocLazyLoadProvider', function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider) {
        ...
        $stateProvider
            ...
            .state('logout', {
                url: '/logout',
                controller: function (admin_login_register, $state, $cookieStore) {
                    admin_login_register.logout().then(function () {
                        $cookieStore.remove("userSID");
                        $state.go('login');
                    });
                },
                resolve: {
                    loadMyFile: function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            name: 'sbAdminApp',
                            files: ['scripts/services/callAPIs.js']
                        })
                    }
                }
            })
                ...
                resolve: {
                    loadMyFile: function ($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            ...
                            files: ['scripts/services/apiKey.js',
                                'scripts/services/callAPIs.js',
                                'scripts/controllers/site-config.js']
                        })
                    }
                }
            })
