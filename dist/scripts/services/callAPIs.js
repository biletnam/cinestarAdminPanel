...
angular.module("sbAdminApp").factory("admin_user", function ($q, $http, apiKey) {
    return {
        getAdminUser: function () {
            return $http.get("" + config.apiUrl + "db/admin/get-admin-user/"+JSON.parse(localStorage.getItem("user_session")).adminUserEmail).success(function (data) {
                return data
            }).error(function (data) {
                return data
            })
        }, updateAdminUser: function (data) {
            return $http.put("" + config.apiUrl + "db/admin/update-admin-user", data).success(function (data) {
                return data
            }).error(function (data) {
                return data
            })
    ...
    return {
        postLogin: function (data) {
            return $http.post("" + config.apiUrl + "db/admin/login-admin", data).success(function (data) {
                return data
            }).error(function (data) {
                return data
            })
        }, postRegistration: function (data) {
            return $http.post("" + config.apiUrl + "db/admin/register-admin", data).success(function (data) {
                return data
            }).error(function (data) {
                return data
            })
